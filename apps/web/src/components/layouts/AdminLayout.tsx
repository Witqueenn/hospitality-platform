...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar items={ADMIN_NAV} title="Admin Portal" accentColor="#f97316" />
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b bg-white px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs text-[#f97316] transition-colors hover:bg-gray-100 hover:text-gray-800"
            >
